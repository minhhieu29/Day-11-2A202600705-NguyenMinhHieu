    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response("Request blocked: Malicious content detected.")

        # 2. Call topic_filter(text)
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("Request is off-topic. I can only assist with banking and finance queries.")
